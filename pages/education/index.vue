<template>
	<div>
		<div class="w-full bg-blue lg:bg-transparent lg:container pt-12 pb-12 lg:mb-3 lg:pb-0 lg:pt-8">
			<h1 class="text-white container lg:px-0 lg:text-blue font-semibold text-3xl pb-2 border-b-2 border-blue">Education</h1>
		</div>
		<div class="container">
			<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 -mt-12 lg:mt-5 mb-5">
				<div v-for="course of courses" :key="course.slug"
					...
					<div class="w-full h-56 overflow-hidden bg-cover bg-center bg-blue flex py-2 px-3 lg:px-5" :style="{backgroundImage:'url('+require(`~/static/images/${course.cover}`)+')'}">

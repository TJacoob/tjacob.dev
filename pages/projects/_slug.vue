<template>
	<div class="">
		<nuxt-link :to="{ name: 'projects'}" class="block w-full bg-blue lg:bg-transparent lg:container pt-12 pb-16 lg:mb-6 lg:pb-0 group">
		...
		<article class="container">
			<div class="flex flex-col lg:flex-row lg:-mr-4">
				...
				<div class="lg:w-3/5 h-48 sm:h-64 lg:h-96 pattern-diagonal flex overflow-hidden shadow-lg rounded-t-lg lg:rounded-lg relative z-20 lg:z-10 -mt-12 lg:my-8 ">
					<!-- Controls -->
					<div @click="slideLeft" v-show="moreThanOneSlide" class="absolute z-20 text-blue-lighter w-10 h-full flex inset-y-0 left-0 group cursor-pointer lg:ml-2">
					...
					<div @click="slideRight" v-show="moreThanOneSlide" class="absolute z-20 text-blue w-10 h-full flex inset-y-0 right-0 group cursor-pointer lg:mr-6">
				...
				<div class="lg:w-2/5 bg-blue-lighter text-white rounded-b-md lg:rounded-md py-8 px-6 lg:px-8 lg:-ml-4 z-10 lg:z-20 shadow-md flex flex-col -mt-4 lg:mt-0">

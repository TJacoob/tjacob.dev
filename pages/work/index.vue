<template>
	<div>
		<div class="w-full bg-blue lg:bg-transparent lg:container pt-12 pb-12 lg:mb-3 lg:pb-0 lg:pt-8">
			<h1 class="text-white container lg:px-0 lg:text-blue font-semibold text-3xl pb-2 border-b-2 border-blue">Previous Work</h1>
		</div>
		<div class="container">
			<div class="grid grid-cols-1 gap-24 lg:gap-10 mt-8 lg:mt-8 mb-4">
				<div v-for="work of works" :key="work.slug" class="flex flex-col lg:flex-row bg-white rounded-3xl shadow-md lg:ml-12">
					<img class="inline w-32 h-32 rounded-full border-2 border-blue-lighter bg-white mx-auto sm:ml-0 lg:mx-auto -mt-20 lg:-ml-16 lg:my-auto" :src="require(`~/static/images/${work.logo}`)"  />
